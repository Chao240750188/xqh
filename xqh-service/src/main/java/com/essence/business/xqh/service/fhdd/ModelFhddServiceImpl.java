...
public class ModelFhddServiceImpl implements ModelFhddService {
    ...
    @Override
    public String savePlan(ModelFhddPlanVo vo) throws Exception {
        String planSystem = PropertiesUtil.read("/filePath.properties").getProperty("FHDD");
...
//                }
    ...
    private Map<String, List<String>> getModelResult(String model_template_output) {
        ...
        try {
            ...
            System.err.println("防洪调度模型调用结果读取失败:read errors :" + e);
            return new HashMap<>();
        } finally {
            try {
                br.close();
    ...
    private int writeDataToInputPcpHRUCsv(String pcp_handle_model_template_input, String pcp_handle_model_template, YwkPlaninfo planInfo) {
        ...
        try {
            ...
            System.err.println("防洪调度模型之PCP模型：pcp_HRU.csv输入文件读取错误:read errors :" + e);
            return 0;
        } finally {
            try {
                br.close();
        ...
        try {
            ...
            bw.close();
            System.out.println("防洪调度模型之PCP模型:防洪调度模型pcp_HRU.csv输入文件写入成功");
            return 1;
        } catch (Exception e) {
            // File对象的创建过程中的异常捕获
            System.out.println("防洪调度模型之PCP模型:防洪调度模型pcp_HRU.csv输入文件写入失败");
            e.printStackTrace();
            return 0;
        }
    }
    ...
    private int writeDataToInputPcpStationCsv(String pcp_handle_model_template_input, List<Map<String, Object>> results, YwkPlaninfo planInfo) {
        ...
        try {
            ...
            bw.close();
            System.out.println("防洪调度模型之PCP模型:防洪调度模型pcp_station.csv输入文件写入成功");
            return 1;
        } catch (Exception e) {
            // File对象的创建过程中的异常捕获
            System.out.println("防洪调度模型之PCP模型:防洪调度模型pcp_station.csv输入文件写入失败");
            e.printStackTrace();
            return 0;
        }
    ...
    private int copyPCPExeFile(String pcp_handle_model_run, String pcp_handle_model_run_plan) {
        ...
        try {
            ...
            System.err.println("防洪调度模型之PCP模型：copy执行文件exe,bat文件成功");
            return 1;
        } catch (Exception e) {
            System.err.println("防洪调度模型之PCP模型：copy执行文件exe,bat文件错误" + e.getMessage());
            return 0;
        }
    }

    /**
     * 修改防洪调度模型的数据模型的config文件
     *
     * @param pcp_handle_model_run_plan
     * @param pcp_handle_model_template_input
    ...
    private int writeDataToPcpConfig(String pcp_handle_model_run_plan, String pcp_handle_model_template_input, String pcp_handle_model_template_output) {
        ...
        try {
            ...
            bw.newLine();
            bw.close();
            System.out.println("防洪调度模型之PCP模型:写入防洪调度模型config成功");
            return 1;
        } catch (Exception e) {
            // File对象的创建过程中的异常捕获
            System.out.println("防洪调度模型之PCP模型:写入防洪调度模型config失败");
            e.printStackTrace();
            return 0;
        }
    ...
    /**
     * 防洪调度模型，chufaduanmian 跟chufaduanmian_shuru
     *
    ...
    private int writeDataToInputShuiWenChuFaDuanMianCsv(String shuiwen_model_template_input, YwkPlaninfo planInfo) {
        ...
        try {
            ...
            bw.close();
            System.out.println("防洪调度模型之防洪调度模型:防洪调度模型ChuFaDuanMian.csv输入文件写入成功");
        } catch (Exception e) {
            // File对象的创建过程中的异常捕获
            System.out.println("防洪调度模型之防洪调度模型:防洪调度模型ChuFaDuanMian.csv输入文件写入失败");
            e.printStackTrace();
            return 0;
        }
        ...
        try {
            ...
            bw.close();
            System.out.println("防洪调度模型之防洪调度模型:防洪调度模型ChuFaDuanMianShuRu.csv输入文件写入成功");
            return 1;
        } catch (Exception e) {
            // File对象的创建过程中的异常捕获
            System.out.println("防洪调度模型之防洪调度模型:防洪调度模型ChuFaDuanMianShuRu.csv输入文件写入失败");
            e.printStackTrace();
            return 0;
        }
    ...
    private int copeFirstOutPutHruP(String pcp_handle_model_template_output, String shuiwen_model_template_input) {
        ...
        try {
            ...
            System.err.println("防洪调度模型之防洪调度模型：copy数据处理模型PCP输出文件hru_p_result文件成功");
            return 1;
        } catch (Exception e) {
            System.err.println("防洪调度模型之防洪调度模型：copy数据处理模型PCP输出文件hru_p_result文件失败" + e.getMessage());
            return 0;
        }
    ...
    private int writeDataToInputShuiWenModelSelectionCsv(String shuiwen_model_template_input, YwkPlaninfo planInfo) {
        ...
        try {
            ...
            bw.newLine();
            bw.close();
            System.out.println("防洪调度模型之防洪调度模型:防洪调度模型model_selection输入文件写入成功");
            return 1;
        } catch (Exception e) {
            // File对象的创建过程中的异常捕获
            System.out.println("防洪调度模型之防洪调度模型:防洪调度模型model_selection输入文件写入失败");
            e.printStackTrace();
            return 0;
        }
...
//                FileOutputStream fos = new FileOutputStream(shuikuChushiShujuReadCsv,true); //为true 时会追加写
            ...
            System.err.println("防洪调度模型之防洪调度模型：修改chushishuishuju.csv文件成功");
            return 1;
        } catch (Exception e) {
            System.err.println("防洪调度模型之防洪调度模型：修改chushishuishuju.csv文件失败" + e.getMessage());
            return 0;
        }
    }
    ...
    private int copyOtherShuiWenLvDingCsv(String shuiwen_model_template, String shuiwen_model_template_input) {
        ...
        try {
            ...
            System.err.println("防洪调度模型之防洪调度模型：copy剩下的率定csv输入文件成功");
            return 1;
        } catch (Exception e) {
            System.err.println("防洪调度模型之防洪调度模型：copy剩下的率定csv输入文件失败" + e.getMessage());
            return 0;
        }
    }
    ...
    private int copyShuiWenExeFile(String shuiwen_model_run, String shuiwen_model_run_plan) {
        ...
        try {
            FileUtil.copyFile(exeUrl, exeInputUrl, true);
            FileUtil.copyFile(batUrl, batInputUrl, true);
            System.err.println("防洪调度模型之防洪调度模型：copy执行文件exe,bat文件成功");
            return 1;
        } catch (Exception e) {
            System.err.println("防洪调度模型之防洪调度模型：copy执行文件exe,bat文件错误" + e.getMessage());
            return 0;
        }
    }
    ...
    private int writeDataToShuiWenConfig(String shuiwen_model_run_plan, String shuiwen_model_template_input, String shuiwen_model_template_output, int tag, YwkPlaninfo planinfo) {
        ...
        try {
            ...
            bw.close();
            System.out.println("防洪调度模型之防洪调度模型:写入防洪调度模型config成功");
            return 1;
        } catch (Exception e) {
            // File对象的创建过程中的异常捕获
            System.out.println("防洪调度模型之防洪调度模型:写入防洪调度模型config失败");
            e.printStackTrace();
            return 0;
        }
    }
