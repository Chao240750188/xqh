...
public class ReservoirListDto {
    ...
    public BigDecimal getFloodWaterLevel() {
        ...
        if (rz != null && fsltdz != null) {
            value = new BigDecimal(0);
            value = rz.subtract(fsltdz).setScale(2, BigDecimal.ROUND_HALF_UP);
        }
        this.floodWaterLevel = value;
    ...
    public BigDecimal getNormalWaterLevel() {
        BigDecimal value = null;
        if (rz != null && normz != null) {
            value = new BigDecimal(0);
            value = rz.subtract(normz).setScale(2, BigDecimal.ROUND_HALF_UP);
        }
        this.normalWaterLevel = value;
