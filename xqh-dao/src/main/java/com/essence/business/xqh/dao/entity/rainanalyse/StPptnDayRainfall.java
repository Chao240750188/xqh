...
@Data
@Entity
@Document(collection = "st_pptn_day_rainfall")
@CompoundIndex(name = "tm_stcd_index", def = "{'tm': 1, 'stcd': 1}",unique = true)
public class StPptnDayRainfall implements Serializable {
 
    private static final long serialVersionUID = -67821122595624080L;
